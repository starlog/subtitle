...
namespace SubtitleBackoffice.Work
{
    static class DBOperation_SyncEpisodes
    {
        ...
        const string delete_query_ContentID =
            @"DELETE FROM EpisodeTable where ProgramId = '{0}'";
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////
        public static bool CleanUp(string ContentID)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(Storage.DB_CONNECTION))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(string.Format(delete_query_ContentID,ContentID), con))
                    {
                        cmd.ExecuteNonQuery();
                    }
                    con.Close();
