...
namespace SubtitleBackoffice.JSON.V2.Episodes
{
    public class _LatestEpisode
    {
        ...
        public _LatestEpisode(string _id, string _name, string _programName, string _programGroupId, string _programGroupName, int _majorEpisodeNumber, string _Streamable, string _MessageForNotStreamable, string _Date, string _Image)
        {
            this.Id = _id;
            this.Name = _name;
